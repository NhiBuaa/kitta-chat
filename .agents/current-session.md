...
| 2 | Client Unified Sidebar Layout & Filter Chips Integration | **TODO** | Thay thế UI sidebar cũ, tích hợp Filter Chips ("Tất cả", "Cá nhân", "Nhóm") lưu localStorage, AND search logic, và Empty States chuyên biệt. |
...
*   Sau Slice 1: Client tests `160/160` passed, Server tests `298/298` passed (100% xanh).