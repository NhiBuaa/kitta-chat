...
const POLICIES = Object.freeze({
  ...
  "state_mutation.message_write": bucket("state_mutation.message_write", 60, MINUTE_MS, 20, "user", "message_write"),
  ...
  "read_expensive.message_history": bucket("read_expensive.message_history", 30, MINUTE_MS, 10, "user", "message_history"),
